...
public static class Noise
{
    ...
    {
        var xi = (int)MathF.Floor(position.X) & 255;
        var yi = (int)MathF.Floor(position.Y) & 255;

        var x = position.X - MathF.Floor(position.X);
        var y = position.Y - MathF.Floor(position.Y);
    ...
    public static float Fractal(Vector2 position, int octaves, float persistence, float lacunarity)
    {
        var total = 0.0f;
        var frequency = 1.0f;
        var amplitude = 1.0f;
